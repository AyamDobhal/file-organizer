class Extensions:
    def __init__(self):
        ...
        self.software_extensions = set(["xpi", "whl", "exe", "msi", "apk", "bat", "bin", "cgi", "pl", "com", "gadget", "jar", "wsf", "vb", "vbs", "py", "pyw", "sh", "cmd", "deb", "rpm", "run", "msu", "msp", "msix", "msixbundle", "appx", "appxbundle", "ps1", "ps1xml", "ps2", "ps2xml", "psc1", "psc2", "msh", "msh1", "msh2", "mshxml", "msh1xml", "msh2xml", "scf", "lnk", "inf", "reg", "dll", "cfg", "cpl", "cur", "deskthemepack", "dll", "dmp", "drv", "icns", "ico", "lnk", "sys", "cfg", "ini", "prf"])
